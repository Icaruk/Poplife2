	...
	_this spawn {
		...
		switch(_mode) do {
			...
			case 1: {
				...
				while {inRace} do {
					hintSilent parseText format ["<t size = '1' align='center' font='TahomaB'>Tiempo </t><br/><t size='0.95' align='center'>Actual: %8</t><br/><t size='1.5'>%1</t><br/><t align='left' color='#E6D525' font='TahomaB'>Minimo: %2 (%3)</t>", [time - raceStartTime] call BIS_fnc_timeToString, _premio select 1];
					sleep 0.02;
				};
			};
			case 2: {
