...
_side = switch(playerSide) do {case west:{"cop"}; case civilian:{"civ"}; case independent:{"med"};case east:{"op"}; };
...
_mstatus ctrlSetStructuredText parseText format["<t size='1.2px'>%1€</t>",[pop_atmdin] call life_fnc_numberText];
_mstatus2 ctrlSetStructuredText parseText format["<t size='1.2'>%1€</t>",[pop_din] call life_fnc_numberText];
