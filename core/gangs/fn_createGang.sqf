...
if(pop_atmdin < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-pop_atmdin)] call life_fnc_numberText];};
