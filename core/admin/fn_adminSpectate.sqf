...
AM_Exit = (findDisplay 46) displayAddEventHandler ["KeyDown","if((_this select 1) == 61) then {(findDisplay 46) displayRemoveEventHandler ['KeyDown',AM_Exit];player switchCamera 'INTERNAL';hint 'Spectate stop';};false"];