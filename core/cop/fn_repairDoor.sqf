...
if(!(typeOf _building) in listaCasas) exitWith {hint "You are not looking at a house door."};
_doors = 1;
while {true} do {
...
for "_i" from 1 to _doors do {
	_selPos = _building selectionPosition format["Door%1_Button",_i];
...
_building animate [format["door%1",_door],0];
