...
if((_this select 3) == "ems" && playerSide != independent) exitWith {hint "No eres un EMS"; closeDialog 0;};
if((_this select 3) == "donator" && playerSide != civilian) exitWith {hint "No eres un Donador"; closeDialog 0;};
