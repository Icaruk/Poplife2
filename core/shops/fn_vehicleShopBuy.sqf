#include <macro.h>
private["_mode","_spawnPoints","_className","_basePrice","_colorIndex","_spawnPoint","_vehicle","_achat","_money","_sp","_vh","_box","_offset"];
...
if(pop_din < _basePrice) exitWith {hint format[localize "STR_Shop_Veh_NotEnough",[_basePrice - pop_din] call life_fnc_numberText];};
