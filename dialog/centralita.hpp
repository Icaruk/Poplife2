class centralita {
	...
	class controls {
		...
		{
			idc = -1;
			text = "Centralita FCSE de Sharani - Asignacion de patrullas"; //--- ToDo: Localize;
		...
		{
			idc = -1;
			text = "Charlie 100:"; //--- ToDo: Localize;
			x = 0.5 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = -1;
			text = "Intervencion:"; //--- ToDo: Localize;
			x = 0.5 * GUI_GRID_W + GUI_GRID_X;
