...
compileFinal "
	...
	[[pop_atmdin,pop_din,owner player,player],""life_fnc_admininfo"",_ret,false] call life_fnc_MP;
";
...
private[""_msg"",""_to""];
	...
	[[_msg,name player,6],""clientMessage"",op,false] call life_fnc_MP;
	[] call life_fnc_cellphone;
	hint format[""You send a Message to all OP´s."",_to,_msg];
	ctrlShow[3023,true];
";
...
publicVariable "fnc_cell_oprequest";
//Client Message
/*
	0 = private message
	1 = police message
...
compileFinal "
	...
	switch (_type) do
	{
		...
		case 6: {
			private[""_message""];
			_message = format[""!!!OP REQUEST: %1"",_msg];
			hint parseText format [""<t color='#FFCC00'><t size='2'><t align='center'>OP Request<br/><br/><t color='#33CC33'><t align='left'><t size='1'>To: <t color='#ffffff'>You<br/><t color='#33CC33'>From: <t color='#ffffff'>%1<br/><br/><t color='#33CC33'>Message:<br/><t color='#ffffff'>%2"",_from,_msg];

			[""TextMessage"",[format[""OP Request from %1"",_from]]] call bis_fnc_showNotification;
		};
