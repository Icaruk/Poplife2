...
if (_param isEqualTo "reset") exitWith {
	if (pop_din < 150000) exitWith {hint "Esto tiene un precio, 150.000€ en concreto."};
	pop_din = pop_din - 150000;
...
if (_param isEqualTo "resetpuntos") exitWith {
	if (pop_din < 2000000) exitWith {hint "Esto tiene un precio, 2.000.000€ en concreto."};
	pop_din = pop_din - 2000000;
