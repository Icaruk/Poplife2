...
"ffaa_armas_ump","ffaa_armas_sdassc","cup_bizon","pop_thomson","hlc_smg_mp510"];
...
"cup_arifle_g36c","cup_arifle_l85a2","cup_arifle_cz805_b","cup_arifle_cz805_b_gl","CUP_arifle_Mk16_STD_FG"];
_listaFrancotiradores = ["r3f_tac50","r3f_pgm_hecate_ii","r3f_frf2_des",
"cup_srifle_m24_des_leupoldmk4lrt","pop_winchester"];
...
_mirM = ["cha_1p78_sight","optic_hamr","optic_nvs","r3f_j4","optic_mrco","optic_arco","ffaa_optic_holografico"];
