...
_fnc_ingredientes = {
	...
	switch (_cosa) do {
		...
		// artesanía
		case "mochila_mediana":{_ingred = [["pop_bamboo_i", 1, "pop_tela", 1], 1] };
		case "mochila_grande": {_ingred = [["pop_bamboo_i", 2, "pop_tela", 2], 25] };
		case "pop_chaleco_carga": {_ingred = [["pop_tela", 4], 25] };
		case "pop_molotov": {_ingred = [["pop_botella", 1, "pop_alcohol", 1, "pop_tela", 1], 20] };
		case "pop_polvora": {_ingred = [["pop_arena_r", 1, "pop_carbon_r", 1], 20] }; // 2
		case "pop_pociondeparkour": {_ingred = [["pop_botella", 1, "pop_coca_b", 1], 20] };
		case "U_O_FullGhillie_sard": {_ingred = [["pop_tela", 3,"pop_bamboo_i",2], 40] };
		case "pop_pociondeinvis": {_ingred = ["pop_botella", 2,"pop_coca_b",2,"pop_alcohol",1] };
		case "pop_winchester": {_ingred = [["pop_lingotehierro", 5,"pop_alcohol",1,"pop_carbon_r",2,"pop_madera",1], 40] };
		case "pop_winchester_384": {_ingred = [["pop_polvora", 1, "pop_lingotehierro",1], 25] };
		...
		case "pop_granlingote": {_ingred = ["pop_lingotehierro", 4] };
		case "pop_componentes": {_ingred = ["pop_hierro_r", 1, "pop_silicio", 1,"pop_cristal",1] };
...
if (_param isEqualTo "actualiza2") exitWith { // ver recetas
	...
	switch (_categoria) do {
		case "Artesanía": {
			_recetas = [
				["mochila_mediana", 1], ["mochila_grande", 1], ["pop_chaleco_carga", 1], ["pop_molotov", 1], ["pop_polvora", 1],
				["pop_pociondeparkour", 1], ["U_O_FullGhillie_sard", 1], ["pop_pociondeinvis", 1], ["pop_winchester", 1],
				["pop_winchester_384", 1]
			];
		};
		case "Materiales": {
			_recetas = [
		...
		case "Equipamiento": {
			_recetas = [["U_B_Wetsuit", 1], ["V_RebreatherB", 1], ["G_Diving", 1]];
		};
		case "Visores": {
			_recetas = [
		...
		case "Otros": {
			_recetas = [["pop_c4", 1], ["O_IR_Grenade", 1], ["pop_bisturi_item", 1], ["pop_tramadol", 1]];
		};
		case "Vehículos": {
			_recetas = [["", 1]];
		};
...
if (_param isEqualTo "craft") exitWith {
	...
	_puedo = switch (true) do {
		...
		case ((_que == "pop_bisturi_item") AND (_inf < 6)): {false};
