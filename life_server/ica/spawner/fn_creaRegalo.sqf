...
if ((typeName _posicion) == "ARRAY") then {
	...
	[[10, "Aviso", [1,0,0], 1.5, _str, [1,1,1], 1], "ica_fnc_anuncio", CIVILIAN, false, false] call life_fnc_MP;
...
[[_caja, ["<t color=""#FFBF00"" size='1' shadow='1'>" +"Buscar componentes electrónicos",' ["componentes"] execVM "ica\spawner\busca.sqf"; ', "", 7,false,true,"",""]], "ica_fnc_meteAccion", true, true] call life_fnc_MP;
